...
public class MatchRegisterView extends AppCompatActivity implements MatchRegisterContract.View {
    ...
    private long teamInMatch; //id del equipo
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teamInMatch = getIntent().getLongExtra("teamInMatch", 0); //guardamos el id que nos traemos de la vista detalle
    ...
    public void saveButtonMatch(View view) {
        EditText etTeamInMatch = findViewById(R.id.et_teamInMatch);
        ...
        long idTeam = Long.parseLong(etTeamInMatch.getText().toString());
        ...
        presenter.registerMatch(idTeam, match);
    }
    ...
    public void showError(String errorMessage) {
        Snackbar.make(((EditText) findViewById(R.id.et_teamInMatch)), errorMessage,
                BaseTransientBottomBar.LENGTH_LONG).show();
    }

    @Override
    public void showMessage(String message) {
        Snackbar.make(((EditText) findViewById(R.id.et_teamInMatch)), message,
                BaseTransientBottomBar.LENGTH_LONG).show();
    }

    @Override
    public void resetForm() {
        ((EditText) findViewById(R.id.et_teamInMatch)).setText("");
